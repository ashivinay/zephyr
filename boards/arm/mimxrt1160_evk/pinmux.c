...
static int mimxrt1160_evk_init(const struct device *dev)
{
	...
	/* LPUART2 TX/RX */
	IOMUXC_SetPinMux(IOMUXC_GPIO_DISP_B2_10_LPUART2_TXD, 0U);
	IOMUXC_SetPinMux(IOMUXC_GPIO_DISP_B2_11_LPUART2_RXD, 0U);
	IOMUXC_SetPinConfig(IOMUXC_GPIO_DISP_B2_10_LPUART2_TXD, 0x02U);
	IOMUXC_SetPinConfig(IOMUXC_GPIO_DISP_B2_11_LPUART2_RXD, 0x02U);
#endif
