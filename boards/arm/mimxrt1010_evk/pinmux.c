 ...
 */
	...
	/* LPUART4 TX/RX */
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_01_LPUART4_RXD, 0);
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_02_LPUART4_TXD, 0);

	IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_01_LPUART4_RXD,
				IOMUXC_SW_PAD_CTL_PAD_PKE_MASK |
				IOMUXC_SW_PAD_CTL_PAD_SPEED(2) |
				IOMUXC_SW_PAD_CTL_PAD_DSE(4));

	IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_02_LPUART4_TXD,
				IOMUXC_SW_PAD_CTL_PAD_PKE_MASK |
				IOMUXC_SW_PAD_CTL_PAD_SPEED(2) |
				IOMUXC_SW_PAD_CTL_PAD_DSE(4));
#endif
