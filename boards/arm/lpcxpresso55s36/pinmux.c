...
static int lpcxpresso_55s36_pinmux_init(const struct device *dev)
{
	ARG_UNUSED(dev);
	...
	pinmux_pin_set(port0, DT_GPIO_PIN(DT_ALIAS(sw1), gpios), sw1_config);
#endif
	...
	pinmux_pin_set(port0, 2, IOCON_PIO_FUNC1  |
				  IOCON_PIO_MODE_INACT |
				  IOCON_PIO_SLEW_STANDARD |
				  IOCON_PIO_INV_DI |
				  IOCON_PIO_DIGITAL_EN |
	...
	pinmux_pin_set(port0, 3, IOCON_PIO_FUNC1  |
				  IOCON_PIO_MODE_INACT |
				  IOCON_PIO_SLEW_STANDARD |
				  IOCON_PIO_INV_DI |
				  IOCON_PIO_DIGITAL_EN |
	...
	/* PORT1 PIN26 is configured as HS_SPI_SSEL3 */
	pinmux_pin_set(port1,  26, IOCON_PIO_FUNC5 |
				  IOCON_PIO_MODE_PULLUP |
				  IOCON_PIO_INV_DI |
				  IOCON_PIO_DIGITAL_EN |
				  IOCON_PIO_SLEW_STANDARD |
...
SYS_INIT(lpcxpresso_55s36_pinmux_init, PRE_KERNEL_1,
