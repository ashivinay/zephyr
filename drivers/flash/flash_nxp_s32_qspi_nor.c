...
#define QSPI_HAS_QUAD_MODE(n)							\
	(DT_INST_NODE_HAS_ENUM_IDX_EQUAL_AND_OR(n, readoc, 3)			\
	 DT_INST_NODE_HAS_ENUM_IDX_EQUAL_AND_OR(n, readoc, 4)			\
	 DT_INST_NODE_HAS_ENUM_IDX_EQUAL_AND_OR(n, writeoc, 2)			\
	 DT_INST_NODE_HAS_ENUM_IDX_EQUAL_AND_OR(n, writeoc, 3)			\
	 0)
...
enum {
	...
	QSPI_SEQ_READ_SFDP,
	QSPI_SEQ_RDID,
#if (DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(readoc, 0) \
	|| QSPI_ANY_INST_HAS_PROP_STATUS_NOT_OKAY(readoc))
	QSPI_SEQ_READ_1_1_1,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(readoc, 1)
	QSPI_SEQ_READ_1_1_2,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(readoc, 2)
	QSPI_SEQ_READ_1_2_2,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(readoc, 3)
	QSPI_SEQ_READ_1_1_4,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(readoc, 4)
	QSPI_SEQ_READ_1_4_4,
#endif
#if (DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(writeoc, 0) \
	|| QSPI_ANY_INST_HAS_PROP_STATUS_NOT_OKAY(writeoc))
	QSPI_SEQ_PP_1_1_1,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(writeoc, 1)
	QSPI_SEQ_PP_1_1_2,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(writeoc, 2)
	QSPI_SEQ_PP_1_1_4,
#endif
#if DT_ANY_INST_HAS_ENUM_IDX_EQUAL_STATUS_OKAY(writeoc, 3)
	QSPI_SEQ_PP_1_4_4,
#endif
};
