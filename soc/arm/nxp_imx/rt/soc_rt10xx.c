...
#endif
	// DD- Make ITCM 256KB, DTCM 192KB, OCRAM 64KB
	// OODDIIIIIIIIDDDD
	IOMUXC_GPR->GPR17 = 0x5AFFFFAA;
	uint32_t reg = IOMUXC_GPR->GPR14;
	reg &= ~0xFF0000;
	// Set ITCM and DTCM to 256KB limit
	reg |= 0x990000;
	IOMUXC_GPR->GPR14 = reg;
	// Apply new flexram configuration
