...
/* Internal version of this function used, since we relocate this code to ITCM */
...
/* Internal version of this function used, since we relocate this code to ITCM */
static void CLOCK_INITUSB1PLL(const clock_usb_pll_config_t *config)
{
	/* Bypass PLL first */
...
void clock_full_power(void)
{
	...
	CLOCK_SETDIV(kCLOCK_FlexspiDiv, flexspi_div);
	CLOCK_SETMUX(kCLOCK_FlexspiMux, 3);
#elif CONFIG_CODE_FLEXSPI2
	CLOCK_SETDIV(kCLOCK_Flexspi2Div, flexspi_div);
